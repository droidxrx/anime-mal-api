...
import { MangaFullArray, MangaInListArray, MangaFull, MangaInList } from "./structures";
...
export default class manga {
     ...
     * @param fields — Array
     */
    search(q: string, offset = 0, limit = 100, fields: MangaInListArray = MangaInList): Promise<Obj> {
     ...
     */
    // prettier-ignore
    ranking(ranking_type: typeRanking = "all", offset = 0, limit = 100, fields: MangaInListArray = MangaInList): Promise<Obj> {
        fields = fields ? fields : MangaInList;
